...
各章は内容を一度に並べず、次の8ステップを1画面ずつ進みます。操作だけに偏らないよう、教科書として読む場面を3回に分けています。

- 章の問い・目標・全体像を読む
- 高校から大学へつながる説明と重要語句を読む
- 読んだ内容から結果を予想する
- ラボで操作して確かめる
- 自分の言葉で理由を説明する
- 数式・よくある誤解・思考問題を読む
...
各章の完了には、章別の予想、指定されたラボ操作、自分の言葉での説明、理解チェック2問、自信度の記録が必要です。「読む → 用語をつかむ → 予想 → 操作 → 説明 → 数式 → 想起 → 応用」を通ってから次へ進む設計です。
